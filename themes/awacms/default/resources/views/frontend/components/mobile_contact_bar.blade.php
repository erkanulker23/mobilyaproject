...
<div class="mobile-contact-bar">
    <div class="mobile-contact-container">
        ...
        <a href="https://wa.me/{{ $generalSettings->whatsapp }}"
           class="mobile-contact-item whatsapp"
           target="_blank"
           ...
           aria-label="WhatsApp ile iletişime geç">
            ...
            <span class="mobile-contact-text">WhatsApp</span>
        </a>
        @endif
        ...
        <a href="mailto:{{ $generalSettings->email }}"
           class="mobile-contact-item email"
           aria-label="E-posta gönder">
            ...
            <span class="mobile-contact-text">E-posta</span>
        </a>
        @endif
        ...
        <a href="tel:{{ $generalSettings->phone }}"
           class="mobile-contact-item phone"
           aria-label="Telefon ara">
            ...
            <span class="mobile-contact-text">Ara</span>
        </a>
        @endif
    </div>
</div>
