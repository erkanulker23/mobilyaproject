...
<div style="font-family:'Manrope',system-ui,sans-serif;color:#1F1C18;background:#fff">
        ...
        <div class="kal-pad" style="max-width:1340px;margin:0 auto;padding:0 52px">
            <div class="kal-split" style="display:grid;grid-template-columns:.85fr 2.15fr;gap:64px;align-items:start">
                ...
                <aside data-reveal style="opacity:0;position:sticky;top:100px">
                    <div style="display:flex;align-items:center;gap:13px;margin-bottom:18px"><span style="width:34px;height:1px;background:#9C8463"></span><span style="font-size:12px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;color:#9C8463">{{ $page->title }}</span></div>
                    @if($page->shortDescription)
                        <p style="font-size:18px;line-height:1.65;color:#1C1813;font-weight:500;margin-bottom:26px">{{ $page->shortDescription }}</p>
                    @endif
                    <div style="background:#F6F3ED;border:1px solid #E6E0D4;border-radius:14px;padding:30px 28px">
                        <div style="font-family:'Plus Jakarta Sans';font-weight:700;font-size:18px;color:#1C1813;margin-bottom:10px">Bir projeniz mi var?</div>
                        ...
                        <a href="{{ route('contact.index') }}" style="display:inline-flex;align-items:center;gap:10px;background:#9C8463;color:#fff;font-weight:700;font-size:14px;padding:15px 26px;text-decoration:none;border-radius:9px;transition:all .3s" style-hover="background:#7D6A4F;transform:translateY(-2px)">İletişime Geç →</a>
                    </div>
                </aside>
    ...
    <style>
        .kal-richtext h1,.kal-richtext h2,.kal-richtext h3,.kal-richtext h4 { font-family:'Plus Jakarta Sans',system-ui,sans-serif; color:#1C1813; font-weight:800; letter-spacing:-.01em; line-height:1.25; }
        ...
        .kal-richtext a { color:#9C8463; text-decoration:none; border-bottom:1px solid rgba(156,132,99,.4); transition:color .3s,border-color .3s; }
        .kal-richtext a:hover { color:#7D6A4F; border-color:#7D6A4F; }
        .kal-richtext ul,.kal-richtext ol { margin:0 0 22px; padding-left:24px; }
        .kal-richtext li { margin:0 0 10px; }
        .kal-richtext ul li::marker { color:#9C8463; }
        .kal-richtext img { max-width:100%; height:auto; border-radius:14px; margin:26px 0; }
        .kal-richtext blockquote { margin:28px 0; padding:20px 26px; border-left:3px solid #9C8463; background:#F6F3ED; border-radius:0 12px 12px 0; font-size:18px; color:#1C1813; font-style:italic; }
        .kal-richtext strong { color:#1C1813; font-weight:700; }
        ...
        .kal-richtext th { background:#F6F3ED; color:#1C1813; font-weight:700; }
