...
@section('head')
    ...
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@500;600;700;800&family=Manrope:wght@400;500;600;700&family=Playfair+Display:wght@500;600;700;800&display=swap" rel="stylesheet">
...
@section('body')
    ...
    <div style="position:fixed;right:22px;bottom:24px;z-index:1200;display:flex;flex-direction:column;gap:12px">
        ...
        <a href="{{ route('contact.index') }}" aria-label="İletişim" style="display:flex;align-items:center;justify-content:center;width:56px;height:56px;border-radius:50%;background:#1C1813;color:#fff;font-size:22px;text-decoration:none;box-shadow:0 10px 30px rgba(43,41,38,.35);transition:transform .35s cubic-bezier(.16,1,.3,1)" style-hover="transform:scale(1.1) translateY(-2px)">✉</a>
    </div>
