...
class RequestFormSection extends Component
{
    use HasViewVariants;
    ...
    public $buttonText = 'Talep Oluştur';
    ...
    public function __construct(public array $data)
    {
        ...
        $this->buttonText = $data['button_text'] ?? $this->buttonText;
        $this->topics = $data['topic_options'] ?? [];
    }
    ...
    {
        return 'frontend.components.request_form_section';
    }
}
